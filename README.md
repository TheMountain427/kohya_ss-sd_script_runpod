...
```bash
# Clone the repo
git clone https://github.com/forestsource/kohya_ss-sd_script_runpod.git
...
Pull requests and issues on [GitHub](https://github.com/forestsource/kohya_ss-sd_script_runpod)
